...
dat_raw <- xlsx_cells('../data/raw_original/DEL.xlsx', sheets = 'SET data')

# read in formatting of cells
dat_raw_formats <- xlsx_formats('../data/raw_original/DEL.xlsx')
...
write.csv(cells_with_diff_colors, '../data/needs_attention/DEL_need_attention.csv', row.names = FALSE)
